            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        <label htmlFor={`${id}-tjm`} className="text-xs font-medium text-slate-600 cursor-pointer">{label} (€/j)</label>
                        <input
                            id={`${id}-tjm`}
                            type="number"
                            value={tjm}
                    ...
                    <div className="flex flex-col gap-1">
                        <label htmlFor={`${id}-days`} className="text-xs font-medium text-slate-600 cursor-pointer">Jours</label>
                        <input
                            id={`${id}-days`}
                            type="number"
                            value={days}
