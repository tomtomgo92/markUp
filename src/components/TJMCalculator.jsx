            ...
            <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl transition-colors flex items-center gap-2 text-sm font-bold shadow-sm hover:shadow-md outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
                    >
                        <Check size={16} />
                        Appliquer
                    </button>
