            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        <label htmlFor={tjmInputId} className="text-xs font-medium text-slate-600 cursor-pointer hover:text-indigo-600 transition-colors">{label} (€/j)</label>
                        <input
                            id={tjmInputId}
                            type="number"
                            value={tjm}
                    ...
                    <div className="flex flex-col gap-1">
                        <label htmlFor={daysInputId} className="text-xs font-medium text-slate-600 cursor-pointer hover:text-indigo-600 transition-colors">Jours</label>
                        <input
                            id={daysInputId}
                            type="number"
                            value={days}
