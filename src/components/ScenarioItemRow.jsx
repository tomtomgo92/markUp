                    ...
                    <div className="relative flex items-center gap-2">
                        <div className="relative">
                            <input
                                ...
                                title={mode === 'pv_percent' ? "Le coût est calculé automatiquement en mode 'Marge & PV'" : undefined}
                            />
                ...
                <div className="relative flex items-center gap-2">
                    <div className="relative">
                        <input
                            ...
                            title={mode === 'cost_percent' ? "Le prix de vente est calculé automatiquement en mode 'Marge & Coût'" : undefined}
                        />
                        <span className="text-xs text-slate-400 absolute right-8 top-1.5 pointer-events-none">€</span>
                    </div>
