                    ...
                    <div className="relative flex items-center gap-2">
                        <div className="relative">
                            <input
                                ...
                                title={mode === 'pv_percent' ? 'Calculé automatiquement à partir de la marge et du PV' : undefined}
                ...
                <div className="relative flex items-center gap-2">
                    <div className="relative">
                        <input
                            ...
                            title={mode === 'cost_percent' ? 'Calculé automatiquement à partir de la marge et du coût' : undefined}
