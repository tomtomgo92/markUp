...
const PriceBreakdown = memo(({ cost, margin, tva }) => {
    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex flex-col items-center justify-center h-full">
            <h4 className="text-[10px] font-black uppercase text-slate-400 tracking-wider mb-4 w-full text-center">Structure du Prix TTC</h4>
            ...
            <div className="w-full mt-6 space-y-2">
                <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-600 font-medium">Coûts</span>
                    </div>
                ...
                <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-600 font-medium">Marge</span>
                    </div>
