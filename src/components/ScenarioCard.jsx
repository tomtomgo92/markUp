...
const ScenarioCard = memo(({ s, onUpdate, onRemove, onDuplicate, index, isClientMode }) => {
    ...
    // BOLT: Optimize - memoize derived calculations based on 's'
    // This avoids recalculating O(N) items when unrelated UI state changes (e.g., activeCalculator or isClientMode)
