...
const ScenarioCard = memo(({ s, onUpdate, onRemove, onDuplicate, index, isClientMode }) => {
    ...
    // BOLT: Optimize - memoize derived calculations to prevent recalculation
    // when only local UI state (like activeCalculator) or parent UI state (like isClientMode) changes.
