...
const ScenarioCard = memo(({ s, onUpdate, onRemove, onDuplicate, index }) => {
    ...
    const marginHealth = (res.marginPercent * 100) >= 40 ? 'good' : (res.marginPercent * 100) >= 20 ? 'mid' : 'low';
            ...
            <div className="scenario-card__head">
                ...
                <div className="scenario-card__head-actions">
                    <div className="scenario-card__select-wrap">
                        ...
                        <ChevronDown className="scenario-card__select-icon" size={14} aria-hidden="true" />
                    </div>
                    <div className="scenario-card__icon-actions print-hidden">
                        <Button type="button" variant="white" size="sm" iconOnly onClick={handlePrint} title="Exporter en PDF / Imprimer ce scénario" aria-label="Exporter en PDF">
                            <Download size={18} />
                        </Button>
                        <Button type="button" variant="white" size="sm" iconOnly onClick={() => onDuplicate(s.id)} title="Dupliquer ce scénario" aria-label="Dupliquer ce scénario">
                            <Copy size={18} />
                        </Button>
                        <ConfirmButton
            ...
            <div className="scenario-card__body">
                <div className="scenario-card__section">
                    {(s.mode === 'cost_percent' || s.mode === 'pv_percent') && (
                        <div className="scenario-card__callout scenario-card__callout--accent">
                            <div className="scenario-card__callout-left">
                                ...
                                <div>
                                    <h4 className="scenario-card__callout-title">Marge Cible Globale</h4>
                                    <p className="scenario-card__callout-hint">S'applique à toutes les lignes</p>
                                </div>
                            </div>
                    ...
                    <div className="scenario-card__lines">
                        <div className="scenario-card__lines-head">
                            ...
                            <button onClick={addItem} className="scenario-card__add-line print-hidden">
                ...
                <div className="scenario-card__callout scenario-card__callout--warning">
                    <div className="scenario-card__callout-left">
                        ...
                        <div>
                            <h4 className="scenario-card__callout-title scenario-card__callout-title--warning">Remise Commerciale</h4>
                            <p className="scenario-card__callout-hint scenario-card__callout-hint--warning">Réduction appliquée sur le total HT</p>
                        </div>
                    </div>
                ...
                <div className="scenario-card__details">
                    ...
                    <div className="scenario-card__details-row">
                        <div className="scenario-card__details-item">
                            <span className="scenario-card__details-label">Marge Brute Cible (HT)</span>
                    ...
                    <div className="scenario-card__health">
                        <span className="scenario-card__health-label">Santé de la marge globale :</span>
                        <div className="scenario-card__health-indicator">
                            <div className={`scenario-card__health-dot scenario-card__health-dot--${marginHealth}`} aria-hidden="true" />
                            <span className={`scenario-card__health-text scenario-card__health-text--${marginHealth}`}>
