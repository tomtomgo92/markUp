...
const ComparisonView = ({ scenarios, onClose }) => {
    // BOLT: Optimize - Wrap calculation in useMemo so it only recalculates when scenarios change
    ...
    // BOLT: Optimize - Wrap maxPV in useMemo to prevent unnecessary array mapping/math on re-renders
