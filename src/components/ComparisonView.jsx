...
const ComparisonView = ({ scenarios, onClose }) => {
    // 1. Calculate results for all scenarios - memoized to prevent expensive mapping on every render
    ...
    // 2. Determine max PV to scale the chart - memoized as it depends on derived data
