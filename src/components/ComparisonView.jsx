...
const ComparisonView = ({ scenarios, onClose, isClientMode }) => {
    // BOLT: Optimize - Memoize array mapping and financial recalculations
    // Avoids redundant O(N) recalculation across all scenarios when only `isClientMode` toggles
