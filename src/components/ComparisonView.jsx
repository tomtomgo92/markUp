...
const ComparisonView = ({ scenarios, onClose, isClientMode }) => {
    // BOLT: Optimize - useMemo to prevent recalculating all scenario results
    // and array mappings when unrelated props (like isClientMode) trigger re-renders
    const data = useMemo(() => {
    ...
    // BOLT: Optimize - memoize the max calculation based on memoized data
    const maxPV = useMemo(() => {
