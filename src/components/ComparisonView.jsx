...
const ComparisonView = ({ scenarios, onClose, isClientMode }) => {
    // BOLT: Optimize - Memoize expensive financial calculations and array mapping
    // This prevents recalculating all math when only `isClientMode` toggles
    ...
    // BOLT: Optimize - memoize chart scaling calculations to prevent recalculation on unrelated renders
