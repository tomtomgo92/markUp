...
const ComparisonView = ({ scenarios, onClose }) => {
    ...
    // BOLT: Optimize - useMemo prevents mapping and recalculating calculateResults on every render
    const data = useMemo(() => {
    ...
    // BOLT: Optimize - useMemo prevents recounting array max value when other state changes
    const maxPV = useMemo(() => {
