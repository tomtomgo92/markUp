...
const ComparisonView = ({ scenarios, onClose }) => {
    ...
    // BOLT: Optimize - memoize mapped derived calculations so changing UI props
    // (like isClientMode) doesn't cause O(n) recalculations of all scenarios
    ...
    // BOLT: Optimize - memoize chart scaling limits
