...
const ComparisonView = ({ scenarios, onClose, isClientMode }) => {
    // BOLT: Optimize - Memoize mapping over scenarios and calculating results
    // This prevents expensive recalculations when toggling isClientMode or other UI-only states
    const data = useMemo(() => {
    ...
    // BOLT: Optimize - Memoize maxPV calculation
