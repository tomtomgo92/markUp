...
const ComparisonView = ({ scenarios, onClose, isClientMode }) => {
    // BOLT: Optimize - useMemo to prevent recalculating all scenario results when isClientMode toggles
    ...
    // BOLT: Optimize - useMemo to prevent recalculating maxPV when isClientMode toggles
