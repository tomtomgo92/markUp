...
const ComparisonView = ({ scenarios, onClose }) => {
    ...
    // BOLT: Optimize - Memoize expensive array operations to prevent recalculation on every render
    ...
    // BOLT: Optimize - Memoize max calculation to avoid unnecessary iterations
