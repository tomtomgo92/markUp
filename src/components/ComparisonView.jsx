...
const ComparisonView = ({ scenarios, onClose }) => {
    ...
    // BOLT: Optimize - Wrap array mapping and financial calculations in useMemo to prevent recalculation on every render
    ...
    // BOLT: Optimize - Wrap max calculation in useMemo to prevent recalculation on every render
