...
## 2026-04-06 - Memoize Derived Data Collections
**Learning:** Generating derived data arrays for charts or complex views by mapping through state arrays and running expensive computations causes significant performance bottlenecks if not memoized, as it triggers on every render.
**Action:** Always wrap expensive derived data calculations and aggregations (like chart data mapping) in useMemo with the original data collection as the dependency.
