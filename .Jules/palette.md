...
## 2026-03-27 - Semantic Form Labels for Better Accessibility
**Learning:** Using semantic <label> elements with htmlFor attributes instead of generic tags (like <h4> or unlinked <label>) significantly improves form accessibility and provides a larger clickable area for inputs.
**Action:** Always link text descriptions to form inputs using unique IDs (via useId or data IDs) and semantic <label> tags.
