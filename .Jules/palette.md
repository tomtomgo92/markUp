...
## 2026-04-04 - [Semantic Labels and Context for Disabled States]
**Learning:** Non-semantic labels reduce clickable area and disabled inputs without explanations cause confusion.
**Action:** Always link <label> elements to inputs via htmlFor/id, and add title attributes explaining why inputs are disabled.
